 ...
 * @param filePath
 */
export const loadConfigSync = (filePath) => jsYaml.safeLoad(fs.readFileSync(path.resolve(baseDir, filePath, '.yaml'), 'utf8'));
/**
 ...
 * @param filePath
 */
export const loadConfigAsync = async (filePath) => {
